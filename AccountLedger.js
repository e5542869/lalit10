            ...
            },
             {
                 ...
                 "render": function (data, type, full, meta) {
                     if (userData.IsOpeningBalanceEditAllow && full.IsEnable == '1' && userData.FinancialYearId == '9') {
                         return '<a href="#" onClick="enableAccountLedger(' + full.LedgerId + ',' + full.IsEnable + ')" class="btn btn-success btn-padding" id="btnDisable">Enabled</a>';
                     }
                     else if (userData.IsOpeningBalanceEditAllow && full.IsEnable == '0' && userData.FinancialYearId == '9') {
                         return '<a href="#" onClick="enableAccountLedger(' + full.LedgerId + ',' + full.IsEnable + ')" class="btn btn-danger btn-padding" id="btnEnable">Disabled</a>';
                     }
                     else
                         return '';
                 }
